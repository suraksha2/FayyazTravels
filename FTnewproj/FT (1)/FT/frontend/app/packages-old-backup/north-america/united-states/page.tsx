...
export default function UnitedStatesPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/north-america/united-states')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading United States packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Experience America's diverse landscapes from iconic cities to national parks, where dreams meet endless possibilities.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "United States Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">USA Adventure Packages</h2>
          <p className="text-gray-600 text-lg">
            Explore America's vast diversity from bustling metropolises to breathtaking natural wonders across 50 states.
          </p>
        </div>
