...
export default function ParisSwitzerlandPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/multi-city/paris-switzerland')
        if (!response.ok) {
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Experience the romance of Paris and the breathtaking beauty of Switzerland.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Paris & Switzerland Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Paris & Switzerland Packages</h2>
          <p className="text-gray-600 text-lg">
            Combine the elegance of Paris with the natural beauty of Switzerland.
          </p>
        </div>
          ...
          {packages.map((pkg: Package) => (
            ...
            >
                ...
                <div className="relative h-56 overflow-hidden">
                  <img 
                    src={pkg.feature_img ? `http://localhost:3003/${pkg.feature_img}` : 'https://images.pexels.com/photos/2064827/pexels-photo-2064827.jpeg'} 
                    alt={pkg.p_name}
