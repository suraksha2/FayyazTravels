...
const itineraryData = [
  {
    ...
    description: "Arrive in Vietnam's bustling southern metropolis and explore the city.",
  ...
  },
  {
    ...
    description: "Discover the UNESCO World Heritage site of Hoi An.",
    image: "https://images.pexels.com/photos/2166559/pexels-photo-2166559.jpeg"
  },
  {
    day: 4,
    title: "Halong Bay Cruise",
    description: "Cruise through the stunning limestone karsts of Halong Bay.",
    image: "https://images.pexels.com/photos/2166559/pexels-photo-2166559.jpeg"
  },
  {
    day: 5,
    title: "Hanoi & Departure",
    description: "Explore Vietnam's capital city before departure.",
    image: "https://images.pexels.com/photos/2166559/pexels-photo-2166559.jpeg"
  }
]

export default function VietnamDiscoveryPage() {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
            Journey through Vietnam's stunning landscapes and rich cultural heritage.
          </p>
        </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    ...
                    <span className="text-xl font-bold text-[#C69C3C]">S$3,599</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    <span className="text-lg">Single Supplement</span>
                    <span className="text-xl font-bold text-[#C69C3C]">S$500</span>
                  </div>
                  <div className="flex justify-between items-center py-3">
                    <span className="text-lg">Child (2-11 years)</span>
                    <span className="text-xl font-bold text-[#C69C3C]">S$2,599</span>
                  </div>
                </div>
      ...
      <div className="bg-[#002147] py-12">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/80 mb-6">
            Contact our travel experts to customize your perfect Vietnamese adventure.
          </p>
