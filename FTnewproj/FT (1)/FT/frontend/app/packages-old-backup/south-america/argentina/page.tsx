...
export default function ArgentinaPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/south-america/argentina')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Argentina packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Experience the passion of tango, stunning Patagonia landscapes, and world-class wine regions.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Argentina Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Argentina Tango Packages</h2>
          <p className="text-gray-600 text-lg">
            Discover Buenos Aires, Patagonia's natural wonders, and Argentina's passionate culture.
          </p>
        </div>
          ...
          {packages.map((pkg: Package) => (
            ...
            >
                ...
                <div className="relative h-56 overflow-hidden">
                  <img 
                    src={pkg.image || 'https://images.pexels.com/photos/1287460/pexels-photo-1287460.jpeg'} 
                    alt={pkg.title}
