...
export default function EcuadorPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/south-america/ecuador')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Ecuador packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Explore Ecuador's incredible biodiversity from the Galápagos Islands to the Amazon rainforest and majestic Andes mountains.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Ecuador Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Ecuador Discovery Packages</h2>
          <p className="text-gray-600 text-lg">
            Journey through Ecuador's diverse ecosystems and experience unique wildlife, culture, and natural wonders.
          </p>
        </div>
