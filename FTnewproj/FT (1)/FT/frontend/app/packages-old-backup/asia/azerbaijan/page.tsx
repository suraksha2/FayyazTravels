...
export default function AzerbaijanPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/asia/azerbaijan')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Azerbaijan packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Discover Azerbaijan's Land of Fire, where ancient traditions meet modern architecture in the crossroads of Europe and Asia.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Azerbaijan Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Azerbaijan Cultural Packages</h2>
          <p className="text-gray-600 text-lg">
            Experience Azerbaijan's rich heritage from Baku's Flame Towers to ancient Silk Road cities and Caspian Sea shores.
          </p>
        </div>
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      <span className="text-xs text-green-600 font-medium">You save S$650</span>
                    </div>
                    <Link 
