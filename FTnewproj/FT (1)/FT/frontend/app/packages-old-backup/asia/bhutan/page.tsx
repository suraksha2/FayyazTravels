...
export default function BhutanPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/asia/bhutan')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Bhutan packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Journey to Bhutan's Last Shangri-La, where Gross National Happiness meets pristine Himalayan peaks and ancient Buddhist traditions.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Bhutan Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Bhutan Happiness Packages</h2>
          <p className="text-gray-600 text-lg">
            Experience Bhutan's unique philosophy of Gross National Happiness in the world's last Buddhist kingdom nestled in the Himalayas.
          </p>
        </div>
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-3 mb-4 flex-wrap">
                    <div className="flex items-center gap-1.5 text-sm text-gray-700">
                      ...
                      <span className="font-medium">{pkg.day_night || '8 Days'}</span>
                    </div>
                    <div className="flex items-center gap-1.5 text-sm text-gray-700">
                      <MapPin className="w-4 h-4" />
                      <span className="font-medium">5 Cities</span>
                    </div>
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      <span className="text-xs text-green-600 font-medium">You save S$750</span>
                    </div>
                    <Link 
