...
export default function BahrainPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/asia/bahrain')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Bahrain packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Explore Bahrain's pearl diving heritage and modern marvels, where ancient traditions blend with contemporary luxury in the Arabian Gulf.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Bahrain Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Bahrain Heritage Packages</h2>
          <p className="text-gray-600 text-lg">
            Discover Bahrain's rich history from ancient Dilmun civilization to modern Formula 1 racing in this island kingdom.
          </p>
        </div>
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-3 mb-4 flex-wrap">
                    <div className="flex items-center gap-1.5 text-sm text-gray-700">
                      ...
                      <span className="font-medium">{pkg.day_night || '5 Days'}</span>
                    </div>
                    <div className="flex items-center gap-1.5 text-sm text-gray-700">
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      <span className="text-xs text-green-600 font-medium">You save S$400</span>
                    </div>
                    <Link 
