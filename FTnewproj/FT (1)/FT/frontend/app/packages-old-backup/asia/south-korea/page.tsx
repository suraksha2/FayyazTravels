...
export default function SouthKoreaPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/asia/asia-south-korea')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading South Korea packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Experience South Korea's dynamic fusion of K-pop culture and ancient palaces, where Seoul's skyline meets traditional hanbok elegance.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "South Korea Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">South Korea K-Culture Packages</h2>
          <p className="text-gray-600 text-lg">
            Immerse yourself in South Korea's vibrant culture from BTS landmarks to Jeju Island, where modern innovation meets timeless traditions.
          </p>
        </div>
          ...
          {packages.map((pkg: Package) => (
            ...
            >
                ...
                <div className="relative h-56 overflow-hidden">
                  <img 
                    src={pkg.image || 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg'} 
                    alt={pkg.title}
