...
export default function BangladeshPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/asia/bangladesh')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Bangladesh packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Experience Bangladesh's golden Bengal heritage, from the Sundarbans mangroves to historic Dhaka, where rivers weave through rich culture.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Bangladesh Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Bangladesh River Packages</h2>
          <p className="text-gray-600 text-lg">
            Discover Bangladesh's natural beauty from the world's largest mangrove forest to ancient archaeological sites and vibrant river life.
          </p>
        </div>
          ...
          {packages.map((pkg: Package) => (
            ...
            >
                ...
                <div className="relative h-56 overflow-hidden">
                  <img 
                    src={pkg.feature_img ? `http://localhost:3003/${pkg.feature_img}` : 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg'} 
                    alt={pkg.p_name}
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-3 mb-4 flex-wrap">
                    <div className="flex items-center gap-1.5 text-sm text-gray-700">
                      ...
                      <span className="font-medium">{pkg.day_night || '6 Days'}</span>
                    </div>
                    <div className="flex items-center gap-1.5 text-sm text-gray-700">
                      <MapPin className="w-4 h-4" />
                      <span className="font-medium">4 Cities</span>
                    </div>
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      <span className="text-xs text-green-600 font-medium">You save S$500</span>
                    </div>
                    <Link 
