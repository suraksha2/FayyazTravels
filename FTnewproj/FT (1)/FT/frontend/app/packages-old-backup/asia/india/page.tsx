    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading India packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Experience India's incredible diversity from the Taj Mahal to Kerala backwaters, where ancient spirituality meets vibrant modern culture.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "India Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">India Golden Triangle Packages</h2>
          <p className="text-gray-600 text-lg">
            Discover India's rich heritage from majestic palaces to spiritual temples, bustling markets to serene hill stations across this incredible subcontinent.
          </p>
        </div>
