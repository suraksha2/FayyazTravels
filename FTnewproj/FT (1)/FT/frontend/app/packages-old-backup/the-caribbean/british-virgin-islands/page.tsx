...
export default function BritishVirginIslandsPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/caribbean/british-virgin-islands')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading British Virgin Islands packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          <h1 className="text-[80px] font-bold leading-none tracking-tight mb-8">
            BRITISH VIRGIN ISLANDS
          </h1>
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Discover pristine sailing waters, secluded beaches, and luxury resorts in the British Virgin Islands.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "British Virgin Islands Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">British Virgin Islands Luxury Packages</h2>
          <p className="text-gray-600 text-lg">
            Experience world-class sailing, pristine beaches, and exclusive island luxury in the BVI.
          </p>
        </div>
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-3 mb-4 flex-wrap">
                    ...
                    <div className="flex items-center gap-1.5 text-sm text-gray-700">
                      ...
                      <span className="font-medium">Multiple Islands</span>
                    </div>
