...
export default function GroupTourPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/packages/group-tours/group-tour')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading group tour packages...</p>
        </div>
      </div>
    )
  }
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg">
            Join our expertly guided group tours for unforgettable experiences with fellow travelers.
          </p>
        </div>
