...
export default function TourOfNorthIndiaPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/packages/group-tours/tour-of-north-india')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading North India packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Discover the rich heritage and culture of North India with our expertly guided group tours.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Tour Of North India Travel Packages",
              packageType: "Group Tour Package",
              destination: "Tour Of North India"
            })}
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">North India Group Tours</h2>
          <p className="text-gray-600 text-lg">
            Experience the incredible heritage and culture of North India with fellow travelers.
          </p>
        </div>
            ...
            <div key={pkg.id} className="bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl group">
              <Link href={`/packages/${pkg.p_slug}`} className="block">
                ...
                <div className="relative h-56 overflow-hidden">
                  <img 
                    src={pkg.feature_img ? `http://localhost:3003/${pkg.feature_img}` : 'https://images.pexels.com/photos/1603650/pexels-photo-1603650.jpeg'} 
                    alt={pkg.p_name}
