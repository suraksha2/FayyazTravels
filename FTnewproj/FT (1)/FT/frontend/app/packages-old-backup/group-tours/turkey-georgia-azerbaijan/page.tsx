...
export default function TurkeyGeorgiaAzerbaijanPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/packages/group-tours/turkey-georgia-azerbaijan')
        if (!response.ok) {
  ...
  const extractPrice = (content: string): number => {
    ...
    return priceMatch ? parseInt(priceMatch[1]) : 5999;
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Caucasus packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Experience three amazing countries in one incredible group journey through the Caucasus region.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Turkey - Georgia - Azerbaijan Travel Packages",
              packageType: "Group Tour Package",
              destination: "Turkey - Georgia - Azerbaijan"
            })}
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Turkey - Georgia - Azerbaijan Tours</h2>
          <p className="text-gray-600 text-lg">
            Explore the rich cultures and histories of three fascinating countries.
          </p>
        </div>
