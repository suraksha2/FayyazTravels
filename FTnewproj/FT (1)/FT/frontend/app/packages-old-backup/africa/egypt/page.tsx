...
export default function EgyptPackagesPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Egypt packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Discover the land of pharaohs, ancient pyramids, and the mighty Nile River.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Egypt Safari Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Discover Egypt</h2>
          <p className="text-gray-600 text-lg">
            From ancient pyramids to Nile cruises, explore Egypt's timeless wonders.
          </p>
        </div>
