...
export default function UgandaPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/africa/africa-uganda')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Uganda packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Discover the Pearl of Africa with its mountain gorillas, stunning landscapes, and rich wildlife.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Uganda Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Uganda Wildlife Packages</h2>
          <p className="text-gray-600 text-lg">
            Experience gorilla trekking, wildlife safaris, and the natural beauty of the Pearl of Africa.
          </p>
        </div>
          ...
          {packages.map((pkg: Package) => (
            ...
            >
                ...
                <div className="relative h-56 overflow-hidden">
                  <img 
                    src={pkg.feature_img ? `http://localhost:3003/${pkg.feature_img}` : 'https://images.pexels.com/photos/631317/pexels-photo-631317.jpeg'} 
                    alt={pkg.p_name}
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-3 mb-4 flex-wrap">
                    ...
                    <div className="flex items-center gap-1.5 text-sm text-gray-700">
                      ...
                      <span className="font-medium">3 Parks</span>
                    </div>
