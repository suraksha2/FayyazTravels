...
export default function NamibiaPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/africa/africa-namibia')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Namibia packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Experience the dramatic landscapes of Namibia, from the towering dunes of Sossusvlei to the wildlife of Etosha.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Namibia Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Namibia Adventure Packages</h2>
          <p className="text-gray-600 text-lg">
            Discover the otherworldly beauty of Namibia's deserts, wildlife, and unique landscapes.
          </p>
        </div>
