...
export default function MoroccoPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/africa/africa-morocco')
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Morocco packages...</p>
        </div>
      </div>
    )
  }
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Discover the magic of Morocco with its vibrant souks, stunning architecture, and rich cultural heritage.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Morocco Travel Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Morocco Packages</h2>
          <p className="text-gray-600 text-lg">
            Experience the enchanting blend of Arab, Berber, and French cultures in Morocco.
          </p>
        </div>
          ...
          {packages.map((pkg: Package) => (
            ...
            >
                ...
                <div className="relative h-56 overflow-hidden">
                  <img 
                    src={pkg.feature_img ? `http://localhost:3003/${pkg.feature_img}` : 'https://images.pexels.com/photos/2166559/pexels-photo-2166559.jpeg'} 
                    alt={pkg.p_name}
