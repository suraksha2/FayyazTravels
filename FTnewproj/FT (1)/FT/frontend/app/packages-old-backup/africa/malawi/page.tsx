...
export default function MalawiPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/africa/africa-malawi');
        if (!response.ok) {
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Discover the warm heart of Africa with stunning lakes and friendly people.
          </p>
          <Button 
            onClick={() => openModal({
              packageName: "Malawi Safari Packages",
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Discover Malawi</h2>
          <p className="text-gray-600 text-lg">
            Experience the warm heart of Africa with our curated Malawi packages.
          </p>
        </div>
        ...
        {packages.length === 0 ? (
          <div className="col-span-full text-center py-12">
            ...
            <p className="text-gray-600">We're currently updating our Malawi packages. Please check back soon!</p>
          </div>
        ) : (
            ...
            {packages.map((pkg) => (
              ...
              >
                <div className="relative">
                  <Image 
                    src={pkg.p_image ? `http://localhost:3003/${pkg.p_image}` : 'https://images.pexels.com/photos/4577774/pexels-photo-4577774.jpeg'} 
                    alt={pkg.p_name}
                    width={400}
                    height={200}
