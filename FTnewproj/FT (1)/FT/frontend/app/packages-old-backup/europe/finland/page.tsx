...
export default function FinlandPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/europe/finland');
        if (!response.ok) {
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Discover the land of a thousand lakes, Northern Lights, and midnight sun.
          </p>
          <Button 
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg">
            From Helsinki's design to Lapland's wilderness, explore Nordic beauty.
          </p>
        </div>
