...
export default function DenmarkPackagesPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        const response = await fetch('http://localhost:3003/destination/europe/denmark');
        if (!response.ok) {
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="text-2xl max-w-2xl mx-auto mb-8">
            Discover Danish hygge, Viking heritage, and stunning Scandinavian design.
          </p>
          <Button 
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg">
            From Copenhagen's colorful Nyhavn to Viking history, explore Danish charm.
          </p>
        </div>
