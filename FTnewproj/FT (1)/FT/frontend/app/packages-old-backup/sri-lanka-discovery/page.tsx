...
const itineraryData = [
  {
    ...
    description: "Arrive in Sri Lanka's commercial capital and explore the vibrant city.",
    image: "https://images.pexels.com/photos/2161449/pexels-photo-2161449.jpeg"
  },
  {
    day: 2,
    title: "Kandy Cultural Triangle",
    description: "Visit the Temple of the Tooth and explore Kandy's cultural heritage.",
    image: "https://images.pexels.com/photos/2161449/pexels-photo-2161449.jpeg"
  },
  {
    day: 3,
    title: "Sigiriya Rock Fortress",
    description: "Climb the ancient rock fortress and explore the surrounding gardens.",
    image: "https://images.pexels.com/photos/2161449/pexels-photo-2161449.jpeg"
  },
  {
    day: 4,
    title: "Nuwara Eliya Tea Country",
    description: "Experience the hill country and visit tea plantations.",
    image: "https://images.pexels.com/photos/2161449/pexels-photo-2161449.jpeg"
  },
  {
    day: 5,
    title: "Galle Fort & Departure",
    description: "Explore the historic Dutch fort before departure.",
    image: "https://images.pexels.com/photos/2161449/pexels-photo-2161449.jpeg"
  }
]

export default function SriLankaDiscoveryPage() {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
            Explore ancient temples and pristine beaches in tropical paradise.
          </p>
        </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    ...
                    <span className="text-xl font-bold text-[#C69C3C]">S$600</span>
                  </div>
      ...
      <div className="bg-[#002147] py-12">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/80 mb-6">
            Contact our travel experts to customize your perfect Sri Lankan adventure.
          </p>
