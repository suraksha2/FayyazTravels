export interface SpendingLimitSetting {
    currency: SpendingLimitSetting.CurrencyEnum;
    _default: number;
    maximum: number;
}
export declare namespace SpendingLimitSetting {
...
//# sourceMappingURL=spendingLimitSetting.d.ts.map