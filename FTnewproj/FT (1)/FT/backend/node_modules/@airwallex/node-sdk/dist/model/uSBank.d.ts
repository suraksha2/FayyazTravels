export interface USBank {
    ...
    account_type?: USBank.AccountTypeEnum;
    ach?: string;
    currency: USBank.CurrencyEnum;
    entity_type: USBank.EntityTypeEnum;
    fedwire?: string;
}
export declare namespace USBank {
    const validAccountTypeEnum: readonly ["CHECKING", "SAVINGS"];
...
//# sourceMappingURL=uSBank.d.ts.map