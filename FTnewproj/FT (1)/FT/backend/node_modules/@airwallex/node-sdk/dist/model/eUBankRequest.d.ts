export interface EUBankRequest {
    account_name: string;
    currency: EUBankRequest.CurrencyEnum;
    entity_type: EUBankRequest.EntityTypeEnum;
    iban: string;
}
export declare namespace EUBankRequest {
...
//# sourceMappingURL=eUBankRequest.d.ts.map