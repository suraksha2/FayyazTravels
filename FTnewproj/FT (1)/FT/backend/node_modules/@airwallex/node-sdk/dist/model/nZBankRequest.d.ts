export interface NZBankRequest {
    account_name: string;
    account_number: string;
    currency: NZBankRequest.CurrencyEnum;
    entity_type: NZBankRequest.EntityTypeEnum;
}
export declare namespace NZBankRequest {
...
//# sourceMappingURL=nZBankRequest.d.ts.map